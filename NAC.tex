...
\hypersetup{
    pdfauthor = {Oliver Wu, Hye},
    pdftitle = {Nonlinear and Adaptive Control},
	% pdfkeywords = {},
    % pdfsubject = {Nonlinear Systems, Adaptive Control}
}
...
\input{Chapter_6/6D.tex}
\input{Chapter_6/6E.tex}
\input{Chapter_6/6F.tex}
\input{Chapter_6/6G.tex}
...
\setindexprenote{\citshape 各条目按照汉语拼音排序。部分条目下有若干子条目，子条目中用波浪线“$\sim$”指代其所属的条目。
    例如，“平衡点（equilibrium point）”条目下的“孤立$\sim$（isolated）”，即表示“孤立平衡点”（isolated equilibrium point）。}
